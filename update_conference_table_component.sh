...
base_path=../conference_application_table.component/src
...
cp -Rfv $base_path/components/conference_application_table/static/* $sc_web_static_path

stage "Install component"

append_js $sc_web_path/templates/components.html components/js/conference_application_table/conference_application_table.js
